    ...
    public static void placeBreweries() {
        ...
        if (economyAPI.getMarket("jangala") != null) {
            ...
            for (Map.Entry<String, String> e : breweryDestinations.entrySet()) {
                if (economyAPI.getMarket(e.getKey()) != null) {
                    ...
                    if (!market.hasIndustry(Brewery.INDUSTRY_ID) && !marketMemory.getBoolean(INIT_KEY)) {
                        ...
                        market.getIndustry(Brewery.INDUSTRY_ID).setSpecialItem(new SpecialItemData(AlcoholRepo.getIndustrial(e.getValue()).getIndustryItemId(), null));
            ...
            for (IndustrialAlcohol industrialAlcohol : AlcoholRepo.getIndustrialAlcoholList()) {
                FactionAPI faction = industrialAlcohol.getFaction();
                ...
                if (largest != null) {
                    ...
                    largest.getIndustry(Brewery.INDUSTRY_ID).setSpecialItem(new SpecialItemData(industrialAlcohol.getIndustryItemId(), null));
                }
            }
        }
