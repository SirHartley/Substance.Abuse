package com.fs.starfarer.api.alcoholism.ui.reference;

import com.fs.starfarer.api.Global;
import com.fs.starfarer.api.alcoholism.ui.BreweryDialoguePlugin;
...
public class BreweryCustomAlcoholPanel implements CustomDialogDelegate {
    ...
    public BreweryDialoguePlugin dialog;
    ...
    public BreweryCustomAlcoholPanel(BreweryDialoguePlugin dialog, Industry industry) {
    ...
    public static class ButtonReportingCustomPanel extends BaseCustomUIPanelPlugin {
        public BreweryCustomAlcoholPanel delegate;
        protected PositionAPI pos;
        public float sideRatio = 0.5f;
        public Color color;
        public float heightOverride = 0f;

        public ButtonReportingCustomPanel(BreweryCustomAlcoholPanel delegate) {
            this.delegate = delegate;
        }

        public ButtonReportingCustomPanel(BreweryCustomAlcoholPanel delegate, Color edgeColour, float heightOverride) {
            this.delegate = delegate;
