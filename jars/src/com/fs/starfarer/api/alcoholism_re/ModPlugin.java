...
import com.fs.starfarer.api.alcoholism_re.hullmods.campaignEffects.ExcessOPStripper;
import com.fs.starfarer.api.alcoholism_re.industry.BreweryPlacer;
import com.fs.starfarer.api.alcoholism_re.listeners.AlcoholConsumptionManager;
import com.fs.starfarer.api.alcoholism_re.listeners.AlcoholStackReplacer;
import com.fs.starfarer.api.alcoholism_re.listeners.ResourceConditionApplicator;
import com.fs.starfarer.api.alcoholism_re.memory.*;
import com.fs.starfarer.api.alcoholism_re.scripts.CargoUIOpenChecker;
import com.fs.starfarer.api.alcoholism_re.scripts.NewDayTracker;
import com.fs.starfarer.api.alcoholism_re.scripts.RefitUIOpenChecker;
